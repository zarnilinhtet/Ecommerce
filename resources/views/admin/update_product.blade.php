    ...
    <div class="slide-left">
        ...
        <div class="content-wrapper">
            ...
            <div class="container" style="margin-bottom:150px">
                <h1 class="text-center" style="font-size: 30px">Update Products</h1>
                <div class="col-md-6 offset-3 mt-4">



                    <form action="{{ url('/update_confirm_product',$show->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control text-dark" id="exampleInputEmail1"
                                ...
                                style="background: rgb(255, 255, 255)" value="{{ $show->title}}">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control text-dark" id="exampleInputEmail1"
                                ...
                                style="background: rgb(255, 255, 255)" value="{{ $show->description}}">
                            @error('description')
                            <div class="text-danger mb-4">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control text-dark" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter Product Description"
                                value="{{ $show->price}}" style="background: rgb(255, 255, 255)">
                            @error('price')
                            <div class="text-danger mb-4">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" name="discount_price" class="form-control text-dark"
                                ...
                                value="{{ $show->discount_price}}" style="background: rgb(255, 255, 255)">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="quantity" class="form-control text-dark" min="0"
                                ...
                                style="background: rgb(255, 255, 255)" value="{{ $show->quantity}}">
                            @error('quantity')
                            <div class="text-danger mb-4">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control text-dark"
                                ...
                                <option value="{{ $show->category}}" selected=""> {{ $show->category}}</option>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Current Product Image</label>
                            <img src="/product/{{ $show->image }}" alt="" width="70" height="70" class="m-auto">

                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">Change Product Image</label>
